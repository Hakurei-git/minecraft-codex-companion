...
| `MinecraftCodexCompanion-AgentKit-v0.1.9.zip` | Users who want Codex, Claude, Antigravity, or another MCP-capable AI to control the NPC | No. It connects to the local service installed by the EXE on the same PC. |
